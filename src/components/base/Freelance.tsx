...
export default function Freelance() {
  return (
    <div className='min-h-screen w-full flex flex-col justify-center items-center mt-20'>
        ...
        <p className='text-gray-600 px-4 dark:text-gray-400 text-[16px] md:text-[24px] max-w-2xl text-center'>I&apos;m working on several freelance projects, with more to be added soon. 😉</p>
